...
export const register = async (req, res) => {
  try {
    ...
    await sendEmail({
      email: user.email,
      subject: 'Versera - Email Verification OTP',
      message
    });
...
export const resendOTP = async (req, res) => {
  try {
    ...
    await sendEmail({
      email: user.email,
      subject: 'Versera - New Verification OTP',
      message
    });
...
export const forgotPassword = async (req, res) => {
  try {
    ...
    await sendEmail({
      email: user.email,
      subject: 'Versera - Password Reset Request',
      message
    });
