              ...
              <div className="p-6 bg-white border-b border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                  <div className="bg-blue-50 p-6 rounded-lg">
                    <h3 className="text-lg font-semibold text-blue-800 mb-2">Total Stories</h3>
                  ...
                  <div className="bg-orange-50 p-6 rounded-lg">
                    <h3 className="text-lg font-semibold text-orange-800 mb-2">Readers</h3>
                    <p className="text-3xl font-bold text-orange-600">0</p>
                  </div>
                </div>

                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold mb-4">Welcome, Writer {user?.firstName}!</h3>
                  <p className="text-gray-600 mb-4">
                    As a writer, you can create and manage your stories, track engagement, 
