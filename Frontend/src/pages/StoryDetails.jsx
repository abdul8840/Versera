          ...
          <div className="sticky top-24">
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              <button 
                ...
                className={`flex items-center justify-center space-x-2 py-2 px-3 rounded-lg font-semibold transition-colors ${isLiked ? 'bg-red-500 text-white hover:bg-red-600' : 'bg-white text-red-500 border border-red-500 hover:bg-red-50'}`}
              >
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm">
              ...
              <div className="space-y-3 text-gray-600">
                <div className="flex items-center">
                  <i className="fas fa-user-circle mr-3 text-xl w-5 text-center"></i>
                  <span>By {story.author.firstName} {story.author.lastName}</span>
                </div>
                <div className="flex items-center">
                  <i className="fas fa-eye mr-3 text-xl w-5 text-center"></i>
                  <span>{story.views} Views</span>
                </div>
                <div className="flex items-center">
                  <i className="fas fa-heart mr-3 text-xl text-red-500 w-5 text-center"></i>
                  <span>{story.likesCount} Likes</span>
                </div>
                <div className="flex items-center">
                  <i className="fas fa-calendar-alt mr-3 text-xl w-5 text-center"></i>
                  <span>Published: {new Date(story.publishedAt).toLocaleDateString()}</span>
                </div>
                <div className="flex items-center">
                  <i className="fas fa-book-open mr-3 text-xl w-5 text-center"></i>
