...
// 1. Import the action to fetch dashboard stats
import { fetchReaderDashboard } from '../../store/slices/dashboardSlice';

const ReaderProfile = () => {
  const dispatch = useDispatch();
  
  // Get Auth state (aliased loading and error to avoid conflicts)
  const { 
    user, 
    loading: authLoading, 
    error: authError, 
  ...
  // 3. Fetch dashboard stats when component loads
  useEffect(() => {
  ...
  // 4. Merge dynamic stats with remaining mock data
  const readerStats = {
    ...stats, // This adds dynamic: storiesRead, likesGiven, commentsWritten, writersFollowed
    ...
    <ReaderLayout>
      <div className="bg-white shadow-sm rounded-lg overflow-hidden">
        <div className="!p-6">
          ...
          {dashboardError && (
            <div className="!mb-6 !p-4 bg-red-50 border border-red-200 rounded-md">
              <p className="text-red-700">Could not load stats: {dashboardError}</p>
            </div>
          )}
          {success && (
          ...
          {!isEditing ? (
            <div className="!space-y-6">
              ...
              {dashboardLoading ? (
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="bg-blue-50 !p-4 rounded-lg text-center">
                    ...
                    <p className="text-blue-800">Stories Saved</p>
                  </div>
              ...
              {/* Reading Preferences (Still Mock) */}
              ...
              {/* Social Links (Dynamic from user object) */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full !px-3 !py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-G-500"
